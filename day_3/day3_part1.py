...
# Starting at the top-left, how many trees would you hit if you went at a slope
#   of right 3 down 1?
...
for i in tree_map:
    ...
    # before next iteration, update horizontal position. Deal with how it wraps
    #   when the map repeats by doing modulus width of map
    horiz_pos += 3
